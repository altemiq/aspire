...
public class WithPostGisTests
{
    ...
    [Test]
    [Arguments("18.2", $"18-{PostGis.PostGisContainerImageTags.PostGisTag}")]
    [Arguments("17.2", $"17-{PostGis.PostGisContainerImageTags.PostGisTag}")]
    [Arguments("16.2", "16-3.5")]
    [Arguments("15.2", "15-3.5")]
    [Arguments("14.2", "14-3.5")]
    [Arguments("13.2", "13-3.5")]
    [Arguments("18-bullseye", $"18-{PostGis.PostGisContainerImageTags.PostGisTag}")]
    [Arguments("17-bullseye", $"17-{PostGis.PostGisContainerImageTags.PostGisTag}")]
    [Arguments("16-bullseye", "16-3.5")]
    [Arguments("15-bullseye", "15-3.5")]
    [Arguments("14-bullseye", "14-3.5")]
    [Arguments("13-bullseye", "13-3.5")]
    [Arguments("bullseye", PostGis.PostGisContainerImageTags.Tag)]
    [Arguments("18-alpine", $"18-{PostGis.PostGisContainerImageTags.PostGisTag}-alpine")]
    [Arguments("17-alpine", $"17-{PostGis.PostGisContainerImageTags.PostGisTag}-alpine")]
    [Arguments("16-alpine", "16-3.5-alpine")]
    [Arguments("15-alpine", "15-3.5-alpine")]
    [Arguments("14-alpine", "14-3.5-alpine")]
    [Arguments("13-alpine", "13-3.5-alpine")]
